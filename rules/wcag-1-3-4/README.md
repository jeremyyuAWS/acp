...
- **Understanding doc:** https://www.w3.org/WAI/WCAG21/Understanding/orientation.html
...
- Module: [`frontend/src/rules/wcag-1-3-4.js`](../../frontend/src/rules/wcag-1-3-4.js)
- Fix mode: `auto`
...
|---------|---------|--------|
| `HTML_ORIENTATION_LOCK` | html | `api/scanner.py:_analyse_html` |

## How to change this rule

- **HTML:** edit [`frontend/src/rules/wcag-1-3-4.js`](../../frontend/src/rules/wcag-1-3-4.js). Change `check()` to alter detection, `fix()` to alter the deterministic remediation. The orchestrator picks it up automatically — no other file changes needed.
