...
- **Understanding doc:** https://www.w3.org/WAI/WCAG21/Understanding/target-size.html
...
- Module: [`frontend/src/rules/wcag-2-5-8.js`](../../frontend/src/rules/wcag-2-5-8.js)
- Fix mode: `human-only`
...
|---------|---------|--------|
| `HTML_TARGET_TOO_SMALL` | html | `api/scanner.py:_analyse_html` |

## How to change this rule

- **HTML:** edit [`frontend/src/rules/wcag-2-5-8.js`](../../frontend/src/rules/wcag-2-5-8.js). Change `check()` to alter detection, `fix()` to alter the deterministic remediation. The orchestrator picks it up automatically — no other file changes needed.
