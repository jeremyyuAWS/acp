...
- **Understanding doc:** https://www.w3.org/WAI/WCAG21/Understanding/labels-or-instructions.html
...
- Module: [`frontend/src/rules/wcag-3-3-2.js`](../../frontend/src/rules/wcag-3-3-2.js)
...
- **HTML:** edit [`frontend/src/rules/wcag-3-3-2.js`](../../frontend/src/rules/wcag-3-3-2.js). Change `check()` to alter detection, `fix()` to alter the deterministic remediation. The orchestrator picks it up automatically — no other file changes needed.
