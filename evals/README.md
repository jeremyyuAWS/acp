...
| `cases/` | 142 generated cases: 40 common, 20 malformed, 15 must-abstain, 15 adversarial, 10 novel, 42 coverage (a second case for every category the first five leave single) |
