...
* **Guided manual test plans.** Phase 3. `acr_manual_test` exists so Phase-1 evidence has somewhere
  to point, and the validation category produces no rows rather than pretending to know.
