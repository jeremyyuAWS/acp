...
- [~] **R8 — WCAG capability completion (the 12 not-ready cells).** Source-verified against
  ...
  in `test_rule_registry.py` (R8 quick-fixes). *(Source-verified 2026-08-24. PR #684 merged.)*
  **~~4 real detector builds~~** ✓ done — detectors added by PRs #676/#679, REVIEW_FORMATS migration
  done in PR #696: `pdf 1.4.1`, `pptx 1.4.11`, `pdf 1.4.11`, `pptx 4.1.2` + `docx 1.4.1`, `docx 1.4.11`
  also migrated (registry-backed since #679). Clean scan now resolves to REVIEW not NOT_EVALUATED.
  *(PR #696 merged.)*
