...
function Fixture() {
  ...
  return <main style={{ maxWidth: 640, margin: '24px auto', padding: 16 }}><h1>Plan</h1><Choices policy={policy} budgetSupported generationChainOptions={options} standingApprovalSupported reviewSupported automaticReviewSupported={false}
