...
it('shows the saved human decision reason before generic lineage guidance', () => {
  const result = remediationRecoveryGuidance({ ...row, _raw: { proposal_snapshot_ids: ['snapshot'], source_revision: 1, decision_version: 1 }, automaticDisposition: { responsibility: 'human', reason: 'The saved policy requires review of this criterion.' } })
