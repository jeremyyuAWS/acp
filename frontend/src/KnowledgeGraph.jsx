...
export default function KnowledgeGraph({ files, scanId = null, readOnly = false }) {
  ...
  return (
    <div className="panel">
      ...
      {selFile && <FileDrawer readOnly={readOnly} context="graph" file={selFile} onClose={() => setSelFile(null)} scanId={scanId} />}
    </div>
  )
}
