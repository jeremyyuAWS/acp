 ...
 *
 * The grid itself is derived from scopePresets.js (generated from the backend's
 * RULE_FORMATS ∪ REVIEW_FORMATS, CI-guarded against drift), so these tests deliberately assert
