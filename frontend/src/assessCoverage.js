...
const REVIEW_ONLY = new Set([
  '2.1.2|docx',                // interactive-control detector (no remediation lane)
  '4.1.2|docx', '4.1.2|xlsx',
  '1.4.1|docx', '1.4.1|xlsx', // Use of Color — colour-only status (docx link underline; xlsx colour scale)
  '1.4.11|docx',               // Non-text Contrast — faint shape outline (docx)
  // pptx pairs (1.4.4, 1.4.10, 1.4.11, 1.4.12, 2.1.2, 2.4.3, 4.1.2) and batch-2 pairs
  // (1.4.1 pdf/pptx, 1.4.10 docx, 1.4.11 pdf, 1.4.12 docx/pdf, 2.1.2 xlsx) are declared
  // in ASSESSMENT_FALLBACK via the registry and REMEDIATION table — no longer listed here.
])
