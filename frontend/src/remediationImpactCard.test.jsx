...
describe('RemediationImpactCard', () => {
  it('blocks a local-only plan before start and retries readiness without changing consent', async () => {
    ...
    getRemediationImpact.mockResolvedValue({ ...result(policy), ai_readiness: { state: 'local_endpoint_reachable', blocked: false, text_model_available: true, vision_model_available: false } })
    ...
    expect(container.textContent).toContain('Text model: available · Vision model: unavailable')
