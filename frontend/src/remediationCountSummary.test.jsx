...
it('counts 299 eligible approvals and 47 manual items across 177 documents, excluding 2000 inspection rows', async () => {
  ...
  await act(async () => root.render(createElement(Header, { counts: { autoFixed: 2400, documents: 177, needsApproval: counts.ready, manual: counts.manual, inspection: counts.inspection } })))
  expect(container.textContent).toContain('299 need approval')
  expect(container.textContent).toContain('47 require manual work')
