...
export default function LiveAssessmentLive({ scanId, active = true, intervalMs = 2000, onStop }) {
  ...
  // Run integrity is deliberately shown only below Assessment results in App.
