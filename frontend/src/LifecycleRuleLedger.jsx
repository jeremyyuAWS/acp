...
export default function LifecycleRuleLedger({ rules = [], onSelect }) {
  ...
  return <section className="panel" aria-labelledby="lifecycle-rule-heading">
    ...
    {rules.length === 0 ? <p>There were no enabled lifecycle rules in this recorded run.</p> : <div style={{ overflowX: 'auto' }}><table style={{ width: '100%' }}>
