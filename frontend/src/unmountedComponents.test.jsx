...
const EXPECTED_UNMOUNTED = [
  ...
  // Retired by the two-slider, server-backed remediation impact planner.
  ...
  // Retired 2026-09-12: Release owns publication; read-only identity observation moved to a hook.
  'RemediationAutoRelease',
  ...
  'RemediationPreview',
  // Retired 2026-09-12: the owner removed embedded publication and additional run details.
  'RemediationReleaseAccess',
  'RemediationRunDetails',
