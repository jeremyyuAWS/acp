...
describe('Review queue action pills', () => {
  it('distinguishes scope-bound PDF map editing from native-tag approval without trusting stale reasons', () => {
    ...
    const mapReason='PDF heading or structure map needs source-document tagging; it is not a writable existing-tag repair'
    const nativeReason='Existing PDF tag repair needs individual approval; its deterministic draft is not covered by automatic AI-call approval'
