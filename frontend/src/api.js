...
// Per-(criterion × format) remediation capability — the single source of truth for
// which WCAG criteria are auto-fixable per file format (see capability.js). SIM and any
// fetch failure fall back to the bundled table, so the format-aware UI never regresses to
// the format-blind view even offline.
