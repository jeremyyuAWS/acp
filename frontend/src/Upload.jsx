...
const FIX_PROPOSAL = {
  ...
  '1.3.3': ['instruction relies on shape/position (“the round button”)', 'reworded to name the control — AI-drafted, human-approved'],
  ...
  '1.4.5': ['heading rendered as an image of text', 'replaced with real <h1> text — human-authored'],
