...
PROPOSAL_KEYS = frozenset({'locator', 'before', 'proposed_value', 'rationale', 'source', 'model', 'model_call_id', 'document_wide_request_id', 'requires_semantic_review',
                           'quality_source_review', 'kind', 'chart_review', 'review_status', 'approval_required', 'automatic_write_blocked', 'reason_code', 'caption_validation', 'figure_image_sha256', 'figure_association_method',
