...
# Both explicit colours (srgbClr) and theme colour references (schemeClr, with optional
# lumMod/lumOff modifiers) are resolved through ppt/theme/theme1.xml. Gradient or image
# fills and non-shape non-text elements (focus indicators, icon glyphs, control borders)
