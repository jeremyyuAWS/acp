...
"""
from . import system, rubric, scans, drive, hitl, ai, disposition, campaigns, capability, sharepoint, control, assess, scope, analytics, public, discovery, openapi_health
...
ROUTERS = [system.router, rubric.router, scans.router, drive.router, hitl.router, ai.router,
          ...
          discovery.router, openapi_health.router]
