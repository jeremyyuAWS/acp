...
ROUTERS = [system.router, rubric.router, scans.router, drive.router, hitl.router, ai.router,
          ...
          stage_executions.router, remediation_policy.router, remediation_waterfall.router, release_continuation.router, automatic_release.router]
