...
"""
from . import system, rubric, scans, drive, hitl, ai, disposition, campaigns, capability, sharepoint, control, assess, scope
...
ROUTERS = [system.router, rubric.router, scans.router, drive.router, hitl.router, ai.router,
          ...
          control.router, assess.router, scope.router]
