...
_KEYS = frozenset({'rule_based', 'ai', 'ai_zone', 'ai_budget_usd', 'auto_approve_ai', 'cloud_input_strategy', 'quality_first',
                   'document_wide_ai', 'document_wide_input_mode', 'document_wide_model_profile', 'generation_chain', 'ai_review', 'fix_approval_policy'})
